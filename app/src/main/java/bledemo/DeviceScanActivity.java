...
public class DeviceScanActivity extends ListActivity {
  ...
  private final static String TAG = DeviceScanActivity.class
      .getSimpleName();
  ...
  private BluetoothAdapter.LeScanCallback mLeScanCallback = new BluetoothAdapter.LeScanCallback() {
    ...
    public void onLeScan(final BluetoothDevice device, int rssi,
      ...
      Log.d(TAG, String.format("Device Name = %s", device.getName()));
      Log.d(TAG, String.format("Device Type = %d", device.getType()));
      Log.d(TAG, String.format("Device RSSI = %d", rssi));
